        ...
        <div className="p-4">
          ...
          {etapa === 1 && (
            <form onSubmit={enviarEmail}>
              <p className="text-muted mb-4">Digite seu email para receber um código de verificação.</p>
              <div className="form-floating mb-4">
                ...
                <label htmlFor="email"><i className="bi bi-envelope me-2"></i>Seu Email</label>
              </div>
